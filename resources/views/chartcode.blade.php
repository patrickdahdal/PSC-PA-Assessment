...
class ChartBuilder
{
    ...
    public static function buildChartImage(array $data)
    {
        ...
        // Chart legend
        $legend = [
            'A' => 'Attention', 'B' => 'Emotion', 'C' => 'Composure',
            'D' => 'Certainty', 'E' => 'Activity', 'F' => 'Boldness',
            'G' => 'Responsibility', 'H' => 'Correct Estimation',
            'I' => 'Empathy', 'J' => 'Communication'
        ];
        ...
        $lineX = $gridRight;
        imageline($chart, $lineX, $gridTop, $lineX, $gridBottom, $axisColor);
